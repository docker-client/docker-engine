...
class DistributionApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun distributionInspect(name: kotlin.String) : DistributionInspectResponse {
        val localVariableConfig = distributionInspectRequestConfig(name = name)

        val localVarResponse = request<DistributionInspectResponse>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as DistributionInspectResponse
    ...
    */
    fun distributionInspectRequestConfig(name: kotlin.String) : RequestConfig {
