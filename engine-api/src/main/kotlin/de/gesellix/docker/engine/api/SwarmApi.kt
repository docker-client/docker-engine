...
class SwarmApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun swarmInit(body: InlineObject5) : kotlin.String {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun swarmJoin(body: InlineObject6) : Unit {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun swarmLeave(force: kotlin.Boolean?) : Unit {
    ...
    * @return RequestConfig
    */
    fun swarmLeaveRequestConfig(force: kotlin.Boolean?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun swarmUnlock(body: InlineObject7) : Unit {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun swarmUpdate(version: kotlin.Long, body: SwarmSpec, rotateWorkerToken: kotlin.Boolean?, rotateManagerToken: kotlin.Boolean?, rotateManagerUnlockKey: kotlin.Boolean?) : Unit {
        val localVariableConfig = swarmUpdateRequestConfig(version = version, body = body, rotateWorkerToken = rotateWorkerToken, rotateManagerToken = rotateManagerToken, rotateManagerUnlockKey = rotateManagerUnlockKey)
    ...
    * @return RequestConfig
    */
    fun swarmUpdateRequestConfig(version: kotlin.Long, body: SwarmSpec, rotateWorkerToken: kotlin.Boolean?, rotateManagerToken: kotlin.Boolean?, rotateManagerUnlockKey: kotlin.Boolean?) : RequestConfig {
        val localVariableBody: kotlin.Any? = body
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
