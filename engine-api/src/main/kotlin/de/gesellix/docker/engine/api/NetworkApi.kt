...
class NetworkApi(basePath: String = defaultBasePath) : ApiClient(basePath) {
  ...
  fun networkConnect(id: String, container: InlineObject3) {
   ...
   */
  fun networkConnectRequestConfig(id: String, container: InlineObject3): RequestConfig {
   ...
   */
  @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
  fun networkDisconnect(id: String, container: InlineObject4) {
   ...
   * @return RequestConfig
   */
  fun networkDisconnectRequestConfig(id: String, container: InlineObject4): RequestConfig {
    val localVariableBody: Any? = container
    val localVariableQuery: MultiValueMap = mutableMapOf()
    val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
