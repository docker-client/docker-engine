...
import de.gesellix.docker.engine.model.InlineObject2
import de.gesellix.docker.engine.model.InlineObject3
import de.gesellix.docker.engine.model.InlineObject4
...
class NetworkApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    ...
    */
    ...
    fun networkConnect(id: kotlin.String, container: InlineObject3) : Unit {
    ...
    */
    fun networkConnectRequestConfig(id: kotlin.String, container: InlineObject3) : RequestConfig {
        val localVariableBody: kotlin.Any? = container
    ...
    */
    ...
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun networkCreate(networkConfig: InlineObject2) : NetworkCreateResponse {
    ...
    * @return RequestConfig
    */
    fun networkCreateRequestConfig(networkConfig: InlineObject2) : RequestConfig {
        val localVariableBody: kotlin.Any? = networkConfig
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun networkDelete(id: kotlin.String) : Unit {
    ...
    * @return RequestConfig
    */
    fun networkDeleteRequestConfig(id: kotlin.String) : RequestConfig {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun networkDisconnect(id: kotlin.String, container: InlineObject4) : Unit {
    ...
    * @return RequestConfig
    */
    fun networkDisconnectRequestConfig(id: kotlin.String, container: InlineObject4) : RequestConfig {
        val localVariableBody: kotlin.Any? = container
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun networkInspect(id: kotlin.String, verbose: kotlin.Boolean?, scope: kotlin.String?) : Network {
    ...
    * @return RequestConfig
    */
    fun networkInspectRequestConfig(id: kotlin.String, verbose: kotlin.Boolean?, scope: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun networkList(filters: kotlin.String?) : kotlin.collections.List<Network> {
        val localVariableConfig = networkListRequestConfig(filters = filters)

        val localVarResponse = request<kotlin.collections.List<Network>>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.collections.List<Network>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    * @return RequestConfig
    */
    fun networkListRequestConfig(filters: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (filters != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun networkPrune(filters: kotlin.String?) : NetworkPruneResponse {
    ...
    * @return RequestConfig
    */
    fun networkPruneRequestConfig(filters: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (filters != null) {
