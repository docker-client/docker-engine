...
import de.gesellix.docker.engine.model.ImagePruneResponse
...
class ImageApi(basePath: kotlin.String = defaultBasePath) : ApiClient(basePath) {
    companion object {
        @JvmStatic
    ...
    */
    ...
    fun buildPrune(keepStorage: kotlin.Long?, all: kotlin.Boolean?, filters: kotlin.String?) : BuildPruneResponse {
    ...
    */
    fun buildPruneRequestConfig(keepStorage: kotlin.Long?, all: kotlin.Boolean?, filters: kotlin.String?) : RequestConfig {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun imageBuild(dockerfile: kotlin.String?, t: kotlin.String?, extrahosts: kotlin.String?, remote: kotlin.String?, q: kotlin.Boolean?, nocache: kotlin.Boolean?, cachefrom: kotlin.String?, pull: kotlin.String?, rm: kotlin.Boolean?, forcerm: kotlin.Boolean?, memory: kotlin.Int?, memswap: kotlin.Int?, cpushares: kotlin.Int?, cpusetcpus: kotlin.String?, cpuperiod: kotlin.Int?, cpuquota: kotlin.Int?, buildargs: kotlin.String?, shmsize: kotlin.Int?, squash: kotlin.Boolean?, labels: kotlin.String?, networkmode: kotlin.String?, contentType: kotlin.String?, xRegistryConfig: kotlin.String?, platform: kotlin.String?, target: kotlin.String?, outputs: kotlin.String?, inputStream: java.io.File?) : Unit {
        val localVariableConfig = imageBuildRequestConfig(dockerfile = dockerfile, t = t, extrahosts = extrahosts, remote = remote, q = q, nocache = nocache, cachefrom = cachefrom, pull = pull, rm = rm, forcerm = forcerm, memory = memory, memswap = memswap, cpushares = cpushares, cpusetcpus = cpusetcpus, cpuperiod = cpuperiod, cpuquota = cpuquota, buildargs = buildargs, shmsize = shmsize, squash = squash, labels = labels, networkmode = networkmode, contentType = contentType, xRegistryConfig = xRegistryConfig, platform = platform, target = target, outputs = outputs, inputStream = inputStream)
    ...
    * @return RequestConfig
    */
    fun imageBuildRequestConfig(dockerfile: kotlin.String?, t: kotlin.String?, extrahosts: kotlin.String?, remote: kotlin.String?, q: kotlin.Boolean?, nocache: kotlin.Boolean?, cachefrom: kotlin.String?, pull: kotlin.String?, rm: kotlin.Boolean?, forcerm: kotlin.Boolean?, memory: kotlin.Int?, memswap: kotlin.Int?, cpushares: kotlin.Int?, cpusetcpus: kotlin.String?, cpuperiod: kotlin.Int?, cpuquota: kotlin.Int?, buildargs: kotlin.String?, shmsize: kotlin.Int?, squash: kotlin.Boolean?, labels: kotlin.String?, networkmode: kotlin.String?, contentType: kotlin.String?, xRegistryConfig: kotlin.String?, platform: kotlin.String?, target: kotlin.String?, outputs: kotlin.String?, inputStream: java.io.File?) : RequestConfig {
        val localVariableBody: kotlin.Any? = inputStream
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (dockerfile != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun imageCommit(container: kotlin.String?, repo: kotlin.String?, tag: kotlin.String?, comment: kotlin.String?, author: kotlin.String?, pause: kotlin.Boolean?, changes: kotlin.String?, containerConfig: ContainerConfig?) : IdResponse {
        val localVariableConfig = imageCommitRequestConfig(container = container, repo = repo, tag = tag, comment = comment, author = author, pause = pause, changes = changes, containerConfig = containerConfig)
    ...
    * @return RequestConfig
    */
    fun imageCommitRequestConfig(container: kotlin.String?, repo: kotlin.String?, tag: kotlin.String?, comment: kotlin.String?, author: kotlin.String?, pause: kotlin.Boolean?, changes: kotlin.String?, containerConfig: ContainerConfig?) : RequestConfig {
        val localVariableBody: kotlin.Any? = containerConfig
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (container != null) {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun imageCreate(fromImage: kotlin.String?, fromSrc: kotlin.String?, repo: kotlin.String?, tag: kotlin.String?, message: kotlin.String?, xRegistryAuth: kotlin.String?, platform: kotlin.String?, inputImage: kotlin.String?) : Unit {
        val localVariableConfig = imageCreateRequestConfig(fromImage = fromImage, fromSrc = fromSrc, repo = repo, tag = tag, message = message, xRegistryAuth = xRegistryAuth, platform = platform, inputImage = inputImage)
    ...
    * @return RequestConfig
    */
    fun imageCreateRequestConfig(fromImage: kotlin.String?, fromSrc: kotlin.String?, repo: kotlin.String?, tag: kotlin.String?, message: kotlin.String?, xRegistryAuth: kotlin.String?, platform: kotlin.String?, inputImage: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = inputImage
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (fromImage != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun imageDelete(name: kotlin.String, force: kotlin.Boolean?, noprune: kotlin.Boolean?) : kotlin.collections.List<ImageDeleteResponseItem> {
        val localVariableConfig = imageDeleteRequestConfig(name = name, force = force, noprune = noprune)

        val localVarResponse = request<kotlin.collections.List<ImageDeleteResponseItem>>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.collections.List<ImageDeleteResponseItem>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    * @return RequestConfig
    */
    fun imageDeleteRequestConfig(name: kotlin.String, force: kotlin.Boolean?, noprune: kotlin.Boolean?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (force != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun imageGet(name: kotlin.String) : java.io.File {
        val localVariableConfig = imageGetRequestConfig(name = name)
    ...
    /**
    * To obtain the request config of the operation imageGet
    *
    * @param name Image name or ID 
    * @return RequestConfig
    */
    fun imageGetRequestConfig(name: kotlin.String) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        ...
        val localVariableConfig = RequestConfig(
            ...
            path = "/images/{name}/get".replace("{"+"name"+"}", "$name"),
            query = localVariableQuery,
            headers = localVariableHeaders,
            body = localVariableBody
        )
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun imageGetAll(names: kotlin.collections.List<kotlin.String>?) : java.io.File {
    ...
    * @return RequestConfig
    */
    fun imageGetAllRequestConfig(names: kotlin.collections.List<kotlin.String>?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (names != null) {
                    put("names", toMultiValue(names.toList(), "csv"))
                }
            }
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun imageHistory(name: kotlin.String) : kotlin.collections.List<HistoryResponseItem> {
        val localVariableConfig = imageHistoryRequestConfig(name = name)

        val localVarResponse = request<kotlin.collections.List<HistoryResponseItem>>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.collections.List<HistoryResponseItem>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    * @return RequestConfig
    */
    fun imageHistoryRequestConfig(name: kotlin.String) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun imageInspect(name: kotlin.String) : Image {
    ...
    * @return RequestConfig
    */
    fun imageInspectRequestConfig(name: kotlin.String) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf()
        val localVariableHeaders: MutableMap<String, String> = mutableMapOf()
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun imageList(all: kotlin.Boolean?, filters: kotlin.String?, digests: kotlin.Boolean?) : kotlin.collections.List<ImageSummary> {
        val localVariableConfig = imageListRequestConfig(all = all, filters = filters, digests = digests)

        val localVarResponse = request<kotlin.collections.List<ImageSummary>>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.collections.List<ImageSummary>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    * @return RequestConfig
    */
    fun imageListRequestConfig(all: kotlin.Boolean?, filters: kotlin.String?, digests: kotlin.Boolean?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (all != null) {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun imageLoad(quiet: kotlin.Boolean?, imagesTarball: java.io.File?) : Unit {
    ...
    * @return RequestConfig
    */
    fun imageLoadRequestConfig(quiet: kotlin.Boolean?, imagesTarball: java.io.File?) : RequestConfig {
        val localVariableBody: kotlin.Any? = imagesTarball
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (quiet != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun imagePrune(filters: kotlin.String?) : ImagePruneResponse {
    ...
    * @return RequestConfig
    */
    fun imagePruneRequestConfig(filters: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (filters != null) {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun imagePush(name: kotlin.String, xRegistryAuth: kotlin.String, tag: kotlin.String?) : Unit {
    ...
    * @return RequestConfig
    */
    fun imagePushRequestConfig(name: kotlin.String, xRegistryAuth: kotlin.String, tag: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (tag != null) {
    ...
    */
    @Suppress("UNCHECKED_CAST")
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun imageSearch(term: kotlin.String, limit: kotlin.Int?, filters: kotlin.String?) : kotlin.collections.List<ImageSearchResponseItem> {
        val localVariableConfig = imageSearchRequestConfig(term = term, limit = limit, filters = filters)

        val localVarResponse = request<kotlin.collections.List<ImageSearchResponseItem>>(
            localVariableConfig
        )

        return when (localVarResponse.responseType) {
            ResponseType.Success -> (localVarResponse as Success<*>).data as kotlin.collections.List<ImageSearchResponseItem>
            ResponseType.Informational -> throw UnsupportedOperationException("Client does not support Informational responses.")
            ResponseType.Redirection -> throw UnsupportedOperationException("Client does not support Redirection responses.")
            ResponseType.ClientError -> {
                val localVarError = localVarResponse as ClientError<*>
    ...
    * @return RequestConfig
    */
    fun imageSearchRequestConfig(term: kotlin.String, limit: kotlin.Int?, filters: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
    ...
    */
    @Throws(UnsupportedOperationException::class, ClientException::class, ServerException::class)
    fun imageTag(name: kotlin.String, repo: kotlin.String?, tag: kotlin.String?) : Unit {
    ...
    * @return RequestConfig
    */
    fun imageTagRequestConfig(name: kotlin.String, repo: kotlin.String?, tag: kotlin.String?) : RequestConfig {
        val localVariableBody: kotlin.Any? = null
        val localVariableQuery: MultiValueMap = mutableMapOf<kotlin.String, List<kotlin.String>>()
            .apply {
                if (repo != null) {
