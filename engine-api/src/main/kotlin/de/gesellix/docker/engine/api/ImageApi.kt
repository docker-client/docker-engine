...
import de.gesellix.docker.engine.client.infrastructure.RequestMethod.DELETE
...
class ImageApi(basePath: String = defaultBasePath) : ApiClient(basePath) {
  ...
  fun imageCreate(
    ...
    val localVariableConfig =
      imageCreateRequestConfig(fromImage = fromImage, fromSrc = fromSrc, repo = repo, tag = tag, message = message, xRegistryAuth = xRegistryAuth, platform = platform, inputImage = inputImage)
  ...
  fun imageCreateRequestConfig(
    ...
    val localVariableBody: Any? = inputImage
    val localVariableQuery: MultiValueMap = mutableMapOf<String, List<String>>()
      .apply {
        if (fromImage != null) {
   ...
   * @return RequestConfig
   */
  fun imageGetRequestConfig(name: String): RequestConfig {
    val localVariableBody: Any? = null
