 ...
 * @param dataPathAddr Address or interface to use for data path traffic (format: `<ip|interface>`), for example,  `192.168.1.1`, or an interface, like `eth0`. If `DataPathAddr` is unspecified, the same addres as `AdvertiseAddr` is used.  The `DataPathAddr` specifies the address that global scope network drivers will publish towards other nodes in order to reach the containers running on this node. Using this parameter it is possible to separate the container data traffic from the management traffic of the cluster.
...
data class InlineObject6 (
    ...
    val advertiseAddr: kotlin.String? = null,
    ...
    val dataPathAddr: kotlin.String? = null,
    /* Addresses of manager nodes already participating in the swarm.  */
    @Json(name = "RemoteAddrs")
    val remoteAddrs: kotlin.collections.List<kotlin.String>? = null,
    /* Secret token for joining this swarm. */
    @Json(name = "JoinToken")
    val joinToken: kotlin.String? = null
)
