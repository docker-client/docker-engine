...
import de.gesellix.docker.rawstream.RawHeaderAndPayload
...
//                    throw new AssertionError("expected header ${k} to be ${v}, got ${chain.request().headers().get(k)}")
    ...
    def "request should return statusLine"() {
        ...
        "Continue"              | 100        | new EngineResponseStatus(text: "Continue", code: 100, success: false)
        "OK"                    | 200        | new EngineResponseStatus(text: "OK", code: 200, success: true)
        "No Content"            | 204        | new EngineResponseStatus(text: "No Content", code: 204, success: true)
        "Found"                 | 302        | new EngineResponseStatus(text: "Found", code: 302, success: false)
        "Not Found"             | 404        | new EngineResponseStatus(text: "Not Found", code: 404, success: false)
        "Internal Server Error" | 500        | new EngineResponseStatus(text: "Internal Server Error", code: 500, success: false)
    }
